  ...
  methods: {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
        	...
        	params.append("username", that.user.account)
        	params.append("email", that.user.email)
        	params.append("phone", that.user.phone)
        	params.append("dept_id", that.user.dept_id)
        	params.append("password1", that.user.password)
        	params.append("password2", that.user.checkPassword)
