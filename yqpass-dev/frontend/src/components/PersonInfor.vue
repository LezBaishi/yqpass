  ...
  methods: {
  	...
  	updateUserinfo (formName) {
  		this.$refs[formName].validate((valid) => {
	  		...
	  		params.append("alias", that.order_form.alias)
	  		params.append("email", that.order_form.email)
	  		params.append("phone", that.order_form.phone)
	  		params.append("job_number", that.order_form.job_number)
	  		params.append("dept_id", that.order_form.dept_id)
