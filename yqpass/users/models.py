...
class User(AbstractUser):
    ...
    # 公司
    company = models.CharField(max_length=20, default='南方基地')
    # 部门
    department = models.CharField(max_length=20, default='网管支撑中心')
    # 室
    team_belong = models.CharField(max_length=20, default='监控分析室')
    # 员工编号
    job_number = models.CharField(max_length=10, default='')
