...
class TicketRecord(models.Model):
    ...
    sn = models.CharField("流水号", max_length=20, help_text="工单编号")
    ...
    application_date = models.DateField("建单日期值", default=str(datetime.datetime.now())[0:10],
                                        blank=True)
...
class TicketFlowLog(models.Model):
    ...
    suggestion = models.CharField("处理意见", max_length=5120, default='', blank=True)
