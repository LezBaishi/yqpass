...
class ConstantService(BaseService):
    ...
    def __init__(self):
        ...
        self.TICKET_BASE_FIELD_LIST = ('id', 'sn', 'title', 'state_id', 'parent_ticket_id', 'parent_ticket_state_id',
                                       ...
                                       'creator', 'is_deleted', 'gmt_created', 'gmt_modified', 'modifier',
                                       'application_date')

        # self.FIELD_DIY_LIST = ('application_detail', )
        self.OCABLE_TYPE = ("单模", "多模",)
        self.OCABLE_LEVEL = ("干线", "广州本地网", "南方基地园区", "南方基地园区（CMNET网络成端）",)
        self.OFIBER_TYPE = ('G652', 'G655',)
