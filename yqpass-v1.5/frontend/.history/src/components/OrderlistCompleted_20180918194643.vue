  ...
  methods: {
	...
	refreshBtn () {
  	...
  	resetForm(formName) {
		...
		console.log(this.search_form.date1,this.search_form.date2)
	},
	getDate (value) {
	...
	created () {
		this.date1 = this.getDate(this.today-157680000000);
		this.date2 = this.getDate(this.today+157680000000);
		console.log(this.date1,this.date2)
		this.search_form.date1 = this.date1;
		this.search_form.date2 = this.date2;
		this.getOrderList();
	}
}
</script>
