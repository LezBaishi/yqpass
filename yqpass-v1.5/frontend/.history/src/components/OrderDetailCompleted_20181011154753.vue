    ...
    <el-row>
				...
				<el-form :model="order_form_empty" class="dialogForm">
					...
					<el-row>
						<el-form-item label="A端设备维护合作单位" :label-width="formLabelWidth">
							...
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.phone2_A"></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
					...
					<el-row>
						<el-col :span="11">
							<el-form-item label="A端业务设备位置" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.rack_num_A" placeholder="填写具体机架号：如A02架"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12" :push="1">
							<el-form-item label="A端业务设备网元名称" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.device_name_A" placeholder="如S9303交换机或核心交换机"></el-input>
							</el-form-item>	
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="12">
							<el-form-item label="A端业务设备端口" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.port_name_A" placeholder="如POS 1/1/0或交换机端口-1"></el-input>
							</el-form-item>	
						</el-col>
					...
					<el-row>
						<el-form-item label="Z端设备移动维护部门" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="部门名称：如XX中心" v-model="order_form_empty.department1_Z"></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="部门负责人" v-model="order_form_empty.person1_Z"></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.person1_ZMobile"></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
  	...
  	<el-row>
  		<el-table :data="order_form" ref="table" tooltip-effect="dark" border stripe style="width:100%">
  			...
  			<el-table-column label="A端业务设备位置（填写具体机架号）" prop="rack_num_A" width="150" align="center">
  				<template slot-scope="scope">
  			...
  			<el-table-column label="A端业务设备/网元名称" prop="device_name_A" width="240" align="center">
  				<template slot-scope="scope">
  			...
  			<el-table-column label="A端业务设备端口" prop="port_name_A" width="240" align="center">
  				<template slot-scope="scope">
  			...
  			<el-table-column label="Z端设备移动维护部门" align="center">
  				...
  				<el-table-column label="联系方式" prop="person1_ZMobile" width="140" align="center">
  					<template slot-scope="scope">
	  					<el-input v-show="scope.row.edit" v-model="scope.row.person1_ZMobile"></el-input>
	  					<span v-show="!scope.row.edit">{{ scope.row.person1_ZMobile }}</span>
  					</template>
  				</el-table-column>  				
  			</el-table-column>
  ...
  methods: {
	...
	submitDialogForm(formName) {
		...
		this.order_form.push({
			...
			person1_ZMobile:this.order_form_empty.person1_ZMobile,
