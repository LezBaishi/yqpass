				...
				<el-form :model="order_form_empty" class="dialogForm">
					...
					<el-row>
						<el-form-item label="Z端设备移动维护部门" :label-width="formLabelWidth">
							...
							<el-col :span="7" :push="1">
								<el-input placeholder="部门负责人" v-model="order_form_empty.person1_Z" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.phone1_Z" clearable></el-input>
							</el-col>
						</el-form-item>
					</el-row>	
					<el-row>
						...
						<el-col :span="8" :push="2">
							<el-form-item label="链路主备关系" label-width="120px">
									<el-select  v-model="order_form_empty.main_or_spare" placeholder="请选择">
		...
		this.$refs[formName].validate((valid) => {
			if (valid) {
				...
				if (key == 2) {
					...
					// json["application_detail"] = JSON.stringify(data_detail);
					var parmas = JSON.stringify(json);
					console.log(parmas);
					postTicketList(parmas).then((response)=> {
						console.log(response);
