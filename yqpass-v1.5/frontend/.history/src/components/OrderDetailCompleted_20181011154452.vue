    ...
    <el-row> 
          ...
          <el-col :span='12' class="breadcrumb">
            <el-breadcrumb separator="/" style='float: right;'>
              <el-breadcrumb-item :to="{ path: '/0/orderCompleted' }">已办工单</el-breadcrumb-item>
  	...
  	<el-row class="header">
  		<el-form ref="orderMain_form" :model="orderMain_form" label-width="80px" disabled=true>
  		...
  		<el-row>
  			...
  			<el-col :span="11" :push="2">  			
	  			<el-form-item label="预计开通时间" label-width="100px">
	  			  <el-date-picker type="date" placeholder="选择开通日期" value-format="yyyy-MM-dd" v-model="orderMain_form.open_date" style="width:100%;"></el-date-picker>	
	  			</el-form-item>
  			</el-col>
  		</el-row>
  		<el-row>
	  		<el-col :span="7">  			
		  		<el-form-item label="* 移动人员" label-width="80px">
		...
		<el-row>			  			
	  		<el-col :span="7">  			
		  		<el-form-item label="* 配合人员" label-width="80px">
			...
			<el-dialog title="新增申请项目" :visible.sync="dialogFormVisible" width="60%" center class="dialog">
				<el-form :model="order_form_empty" class="dialogForm">
					<el-form-item label="业务系统" :label-width="formLabelWidth">
						<el-input placeholder="如南方基地信息支撑平台" v-model="order_form_empty.bus_sys_name"></el-input>
					</el-form-item>
					<el-row>
						<el-form-item label="A端设备移动维护部门" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="部门名称：如XX中心" v-model="order_form_empty.department1_A"></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="部门负责人" v-model="order_form_empty.person1_A"></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.person1_AMobile"></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
  	...
  	<el-row>
  		<el-table :data="order_form" ref="table" tooltip-effect="dark" border stripe style="width:100%">
  			...
  			<el-table-column label="A端设备移动维护部门" align="center">
  				...
  				<el-table-column label="联系方式" prop="person1_AMobile" width="140" align="center">
  					<template slot-scope="scope">
	  					<el-input v-show="scope.row.edit" v-model="scope.row.person1_AMobile"></el-input>
	  					<span v-show="!scope.row.edit">{{ scope.row.person1_AMobile }}</span>
  					</template>
  				</el-table-column>  				
  			</el-table-column>
...
<script>
import { postTicketList,getWorkflowInitState,getTicketDetail,getTicketFlowlogs,getTicketFlowsteps } from '../api/api'
export default {
  data () {
    return {
  ...
  methods: {
	...
	submitDialogForm(formName) {
		...
		this.order_form.push({
			...
			person1_AMobile:this.order_form_empty.person1_AMobile,
	...
	backToList () {
		this.$router.push('/0/orderCompleted')
	},
	selectRow (val) {
