        	...
        	<el-table :data="tableData" v-loading="loading">
  			...
  			<el-table-column
            	...
            	<template slot-scope="scope">
					<el-button type="primary" circle size="mini" icon="el-icon-view" @click="onBtnDetailClick(scope.$index, tableData)"></el-button>
					<el-button type="danger" circle size="mini" icon="el-icon-delete" @click="onBtnDeleteClick(scope.$index, tableData)"></el-button>
            	</template>
       		 </el-table-column>
  			</el-table>
		</el-row>
