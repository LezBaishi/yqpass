    ...
    <el-row> 
          ...
          <el-col :offset="12" :span='12' class="breadcrumb">
            <el-breadcrumb separator="/" style='float: right;'>
              ...
              <el-breadcrumb-item>待办工单</el-breadcrumb-item>
            </el-breadcrumb>
          </el-col>      
    </el-row>
...
<script>
import { postTicketList,getWorkflowInitState,getTicketDetail,dealTicket } from '../api/api'
export default {
  data () {
    return {
  ...
  methods: {
	...
	getOrderDetail (id) {
		getTicketDetail,dealTicket(id).then((response)=> {
