      		...
      		<el-form ref="search_form" :model="search_form" label-width="80px">
       		<el-row>
      			...
      			<el-col :offset="3" :span="8">
					<el-form-item  label="光缆ODF" prop="ocable_odf_A">
						<el-input placeholder="请输入光缆ODF" v-model="search_form.ocable_odf_A" style="width:100%;" clearable></el-input>
					</el-form-item>
      			</el-col>
      			<el-col :push="2" :span="8">
					<el-form-item label="光缆转接设备端口" prop="switch_dport_A">
						<el-input placeholder="请输入光缆转接设备端口" v-model="search_form.switch_dport_A" style="width:100%;" clearable></el-input>
					</el-form-item>
      			</el-col>	      		
			</el-row>
			<el-row>
