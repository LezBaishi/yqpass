        	...
        	<el-table :data="tableData" v-loading="loading">
  			...
  			<el-table-column
            	...
            	<template slot-scope="scope">
					<el-button type="success" @click="onBtnDetailClick(scope.$index, tableData)">详情</el-button>
					<el-button type="danger" @click="onBtnDeleteClick(scope.$index, tableData)">删除</el-button>
            	</template>
       		 </el-table-column>
  			</el-table>
		</el-row>
