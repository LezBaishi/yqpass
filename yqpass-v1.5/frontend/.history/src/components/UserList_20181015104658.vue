        ...
        <el-row>
          ...
          <el-col :span='12' class="breadcrumb">
            <el-breadcrumb separator="/" style='float: right;'>
              <el-breadcrumb-item :to="{ path: '/3/userList' }">用户管理</el-breadcrumb-item>
        	...
        	<el-table :data="tableData" v-loading="loading">
  			...
  			<el-table-column
            	...
            	<template slot-scope="scope">
					<el-button type="primary" circle size="small" icon="el-icon-view" @click="onBtnDetailClick(scope.$index, tableData)"></el-button>
					<el-button type="danger" circle size="small" icon="el-icon-delete" @click="onBtnDeleteClick(scope.$index, tableData)"></el-button>
            	</template>
       		 </el-table-column>
  			</el-table>
		</el-row>
...
export default {
  ...
  methods: {
	...
	onBtnDetailClick (index, rows) {
		...
		this.$router.push({path: '/3/UserListDetail', query: {id: rowValue.id}})
	},
