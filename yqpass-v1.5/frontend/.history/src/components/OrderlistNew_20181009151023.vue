				...
				<el-form :model="order_form_empty" class="dialogForm">
					...
					<el-row>
						<el-form-item label="Z端设备维护合作单位" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="如XX公司" v-model="order_form_empty.department2_Z" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="公司负责人" v-model="order_form_empty.person2_Z" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.person2_ZMobile" clearable></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
					...
					<el-row>
						<el-form-item label="Z端业务设备位置" :label-width="formLabelWidth">
							<el-input v-model="order_form_empty.rack_num_Z" placeholder="填写具体机架号：如A02架" clearable></el-input>
						</el-form-item>
					</el-row>
					<el-row>
  	...
  	<el-row>
  		<el-table :data="order_form" ref="table" tooltip-effect="dark" border stripe style="width:100%">
			...
			<el-table-column label="Z端设备维护合作单位" align="center">
				...
				<el-table-column label="联系方式" prop="person2_ZMobile" width="140" align="center">
					<template slot-scope="scope">
						<el-input v-show="scope.row.edit" v-model="scope.row.person2_ZMobile"></el-input>
						<span v-show="!scope.row.edit">{{ scope.row.person2_ZMobile }}</span>
					</template>
				</el-table-column>
			</el-table-column>
  ...
  methods: {
	...
	submitDialogForm(formName) {
		...
		this.order_form.push({
			...
			person2_ZMobile:this.order_form_empty.person2_ZMobile,
