			...
			<el-table-column label="Z端设备维护合作单位" align="center">
  			...
  			<el-table-column label="链路主备关系" width="110" align="center">
  				<template slot-scope="scope">
	  				...
	  				<span v-show="!scope.row.edit">{{ <scope class="row main_or_spare_view"></scope> }}</span>
  				</template>
			</el-table-column>
  ...
  methods: {
	...
	submitDialogForm(formName) {
		...
		if (this.data_dialogForm == this.order_form_empty) {
			...
			this.order_form_empty.main_or_spare==main?main_or_spare_text='主用':main_or_spare_text='备用'
