  ...
  <el-row class="panel">
    <el-row class="top">
      <el-col :span='24' class="panel-top">
        <el-col style="width:180px; padding-left:20px; height: 100%;align-items: center;">
        ...
        <el-col class='rightbar'>
          <el-menu mode="horizontal" @select="handleSelect" background-color="#C4C4C4" text-color="#fff" active-text-color="#ffd04b">
            <el-submenu index="1">
