<template lang="html"> 
  <div>
    ...
    <el-row> 
  	...
  	<el-row class="header">
  		<el-form ref="orderMain_form" :model="orderMain_form" :rules='orderMain_rules'>
  		<el-row style="margin-bottom:15px;">
  			<el-col :span="12" :push="12" text-align="right">
  				<p style="font-size:14px;float: right;font-weight:bold;">申请时间：{{ applyDate | formatDate }}</p>
  			</el-col>
  		</el-row>
  		<el-row>
  			<el-col :span="11">  			
	  			<el-form-item label="* 项目名称" prop="project_name" label-width="80px">
	  				<el-input placeholder="请输入项目名称" v-model="orderMain_form.project_name" clearable></el-input>
	  			</el-form-item>
  			</el-col>			
  			<el-col :span="11" :push="2">  			
	  			<el-form-item label="预计开通时间" prop="date" label-width="100px">
	  			  <el-date-picker type="date" placeholder="选择开通日期" value-format="yyyy-MM-dd" v-model="orderMain_form.date" style="width:100%;" readonly=true></el-date-picker>	
	  			</el-form-item>
  			</el-col>
  		</el-row>
  		<el-row>
	  		<el-col :span="7">  			
		  		<el-form-item label="* 移动人员" prop="CMer_name" label-width="80px">
		  			<el-input placeholder="请填写姓名" v-model="orderMain_form.CMer_name" clearable></el-input>
		  		</el-form-item>
	  		</el-col>
	  		<el-col :span="7" :offset="1">  			
		  		<el-form-item label="* 电话" prop="CMer_phone" label-width="80px">
		  			<el-input placeholder="请填写手机号" v-model="orderMain_form.CMer_phone" clearable></el-input>
		  		</el-form-item>
	  		</el-col>  
	  		<el-col :span="7" :offset="1">  			
		  		<el-form-item label="* 邮箱" prop="CMer_email" label-width="80px">
		  			<el-input placeholder="请填写邮箱" v-model="orderMain_form.CMer_email" clearable></el-input>
		 			</el-form-item>
	  		</el-col>	
	  	</el-row>  			
		<el-row>			  			
	  		<el-col :span="7">  			
		  		<el-form-item label="* 配合人员" prop="CPer_name" label-width="80px">
		  			<el-input placeholder="请填写姓名" v-model="orderMain_form.CPer_name" clearable></el-input>
				</el-form-item>
	  		</el-col>
	  		<el-col :span="7" :offset="1">  			
		  		<el-form-item label="* 电话" prop="CPer_phone" label-width="80px">
		  			<el-input placeholder="请填写手机号" v-model="orderMain_form.CPer_phone" clearable></el-input>
		  		</el-form-item>
	  		</el-col>  
	  		<el-col :span="7" :offset="1">  			
		  		<el-form-item label="* 邮箱" prop="CPer_email" label-width="80px">
		  			<el-input placeholder="请填写邮箱" v-model="orderMain_form.CPer_email" clearable></el-input>
		  		</el-form-item>
	  		</el-col> 	  							
  		</el-row>  		
 		</el-form>
    ...
    <el-row>	
		<el-button type="primary" style="float:left;margin-bottom:10px;" size="mini" round @click="dialogFormVisible = true">新增表行</el-button>  
			<el-dialog title="新增申请项目" :visible.sync="dialogFormVisible" width="66%" center class="dialog">
				<el-form :model="order_form_empty" class="dialogForm">
					<el-form-item label="业务系统" :label-width="formLabelWidth">
						<el-input placeholder="如南方基地信息支撑平台" v-model="order_form_empty.businessSystem" clearable></el-input>
					</el-form-item>
					<el-row>
						<el-form-item label="A端设备移动维护部门" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="如XX中心" v-model="order_form_empty.ACM_department" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="部门负责人" v-model="order_form_empty.ACM_header" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.ACM_headerMobile" clearable></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
						<el-form-item label="A端设备维护合作单位" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="如XX公司" v-model="order_form_empty.ACP_department" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="公司负责人" v-model="order_form_empty.ACP_header" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.ACP_headerMobile" clearable></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
						<el-col :span="8">
							<el-form-item label="A端业务设备楼栋" :label-width="formLabelWidth">							
								<el-select v-model="order_form_empty.A_machineBuilding" placeholder="请选择" v-on:change="get_machineBuilding($event)">
						...
						<el-col :span="8" :push="2">
							<el-form-item label="机房号" label-width="120px">
								<el-select v-model="order_form_empty.A_machineRoom" placeholder="请选择" v-on:change="get_machineRoom($event)">
					...
					<el-row>
						<el-form-item label="A端业务设备位置" :label-width="formLabelWidth">
							<el-input v-model="order_form_empty.A_machineRack" placeholder="填写具体机架号：如A02架" clearable></el-input>
						</el-form-item>
					</el-row>
					<el-row>
						<el-form-item label="A端业务设备网元名称" :label-width="formLabelWidth">
							<el-input v-model="order_form_empty.A_deviceName" placeholder="如S9303交换机或核心交换机" clearable></el-input>
						</el-form-item>	
					</el-row>
					<el-row>
						<el-col :span="14">
							<el-form-item label="A端业务设备端口" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.A_devicePort" placeholder="如POS 1/1/0或交换机端口-1" clearable></el-input>
							</el-form-item>	
						</el-col>
						<el-col :span="8" :push="1">
							<el-form-item label="端口类型" label-width="120px">
									<el-select  v-model="order_form_empty.A_portType" placeholder="请选择">
					...
					<el-row>
						<el-form-item label="Z端设备移动维护部门" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="如XX中心" v-model="order_form_empty.ZCM_department" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="部门负责人" v-model="order_form_empty.ZCM_header" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.ZCM_headerMobile" clearable></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
						<el-form-item label="Z端设备维护合作单位" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="如XX公司" v-model="order_form_empty.ZCP_department" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="公司负责人" v-model="order_form_empty.ZCP_header" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.ZCP_headerMobile" clearable></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
						<el-col :span="8">
							<el-form-item label="Z端业务设备楼栋" :label-width="formLabelWidth">
								<el-select v-model="order_form_empty.Z_machineBuilding" placeholder="请选择" v-on:change="get_machineBuilding($event)">
									<el-option v-for="item in machineBuilding_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
						<el-col :span="8" :push="2">
							<el-form-item label="机房号" label-width="120px">
								<el-select v-model="order_form_empty.Z_machineRoom" placeholder="请选择" v-on:change="get_machineRoom($event)">
									<el-option v-for="item in machineRoom_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
								</el-select>
							</el-form-item>
						</el-col>
					...
					<el-row>
						<el-form-item label="Z端业务设备位置" :label-width="formLabelWidth">
							<el-input v-model="order_form_empty.Z_machineRack" placeholder="填写具体机架号：如A02架" clearable></el-input>
						</el-form-item>
					</el-row>
					<el-row>
						<el-form-item label="Z端业务设备网元名称" :label-width="formLabelWidth">
							<el-input v-model="order_form_empty.Z_deviceName" placeholder="如S9303交换机或核心交换机" clearable></el-input>
						</el-form-item>	
					</el-row>
					<el-row>
						<el-col :span="14">
							<el-form-item label="Z端业务设备端口" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.Z_devicePort" placeholder="如POS 1/1/0或交换机端口-1" clearable></el-input>
							</el-form-item>	
						</el-col>
						<el-col :span="8" :push="1">
							<el-form-item label="端口类型" label-width="120px">
									<el-select  v-model="order_form_empty.Z_portType" placeholder="请选择">
										<el-option v-for="item in portType_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
									</el-select>
							</el-form-item>	
						</el-col>
					...
					<el-row>
						<el-col :span="8">
							<el-form-item label="需求带宽" :label-width="formLabelWidth">
									<el-select  v-model="order_form_empty.bandwidth" placeholder="请选择">
						...
						<el-col :span="8" :push="2">
							<el-form-item label="链路主备关系" label-width="120px">
									<el-select  v-model="order_form_empty.linkRelations" placeholder="请选择">
				...
				<div slot="footer" class="dialog-footer">
					<el-button @click="resetDialogForm('order_form_empty')">取消</el-button>
					<el-button type="primary" @click="submitDialogForm('order_form_empty')">确定</el-button>
				</div>
			</el-dialog>	
  	</el-row>
  	<el-row>
  		<el-table :data="order_form" ref="table" tooltip-effect="dark" border stripe style="width:100%">
  			...
  			<el-table-column label="A端业务设备位置" align="center">
				...
				<el-table-column label="机架号" prop="A_machineRack" width="150" align="center">
					<template slot-scope="scope">
  			...
  			<el-table-column label="A端业务设备" align="center">  			
				<el-table-column label="网元名称" prop="A_deviceName" width="240" align="center">
					<template slot-scope="scope">
				...
				<el-table-column label="设备端口" prop="A_devicePort" width="240" align="center">
					<template slot-scope="scope">
			...
			<el-table-column label="Z端业务设备" align="center">
				...
				<el-table-column label="设备端口" prop="Z_devicePort" width="240" align="center">
					<template slot-scope="scope">
				...
				<el-table-column label="网元名称" prop="Z_deviceName" width="240" align="center">
					<template slot-scope="scope">
			...
			<el-table-column label="Z端业务设备位置" align="center">
				...
				<el-table-column label="机架号" prop="Z_machineRack" width="150" align="center">
					<template slot-scope="scope">
  ...
  <el-row class="footer">
  	<el-row>
  		<el-button type="warning" icon="el-icon-warning" @click="readIns">填单说明</el-button>
		<el-button type="primary" icon="el-icon-success" v-for="(value, key) in button_list" :key="key" @click="handleData(value.transition_id, 'orderMain_form')">{{ value.transition_name }}</el-button>
  	</el-row>
...
<script>
import { postTicketList,getWorkflowInitState } from '../api/api'
export default {
  data () {
  ...
  methods: {
	...
	submitDialogForm(formName) {
		...
		this.order_form.push({
			id:this.nextId++,
			businessSystem:this.order_form_empty.businessSystem,
			ACM_department:this.order_form_empty.ACM_department,
			ACM_header:this.order_form_empty.ACM_header,
			ACM_headerMobile:this.order_form_empty.ACM_headerMobile,
			ACP_department:this.order_form_empty.ACP_department,
			ACP_header:this.order_form_empty.ACP_header,
			ACP_headerMobile:this.order_form_empty.ACP_headerMobile,
			A_machineBuilding:this.order_form_empty.A_machineBuilding,
			A_machineRoom:this.order_form_empty.A_machineRoom,
			A_machineRack:this.order_form_empty.A_machineRack,
			A_deviceName:this.order_form_empty.A_deviceName,
			A_devicePort:this.order_form_empty.A_devicePort,
			A_portType:this.order_form_empty.A_portType,
			A_odfRack:this.order_form_empty.A_odfRack,
			ZCM_department:this.order_form_empty.ZCM_department,
			ZCM_header:this.order_form_empty.ZCM_header,
			ZCM_headerMobile:this.order_form_empty.ZCM_headerMobile,
			ZCP_department:this.order_form_empty.ZCP_department,
			ZCP_header:this.order_form_empty.ZCP_header,
			ZCP_headerMobile:this.order_form_empty.ZCP_headerMobile,
			Z_machineBuilding:this.order_form_empty.Z_machineBuilding,
			Z_machineRoom:this.order_form_empty.Z_machineRoom,
			Z_machineRack:this.order_form_empty.Z_machineRack,
			Z_deviceName:this.order_form_empty.Z_deviceName,
			Z_devicePort:this.order_form_empty.Z_devicePort,
			Z_portType:this.order_form_empty.Z_portType,
			Z_odfRack:this.order_form_empty.Z_odfRack,
			bandwidth:this.order_form_empty.bandwidth,
			linkRelations:this.order_form_empty.linkRelations,
			notes: '',
			edit:false
		});
	...
	getOrderInitState () {
		getWorkflowInitState().then((response)=> {
			// var list = response.data.data.transition;
			// for (var i=0; i<list.length; i++) {
			// 	console.log(list[i].transtion_name)
			// 	this.button_list.push({name:list[i].transtion_name});
			// }
			this.button_list = response.data.data.transition;
			console.log(this.button_list);
		})
	},
	handleData (key, formName) {
		this.$refs[formName].validate((valid) => {
			if (valid) {
				console.log(key);
				if (key == 1) {
					var that = this;
					let date = that.getDate(that.applyDate);
					let json = {};
					json["workflow_id"] = 1;
					json["transition_id"] = key;
					json["title"] = that.orderMain_form.project_name;
					json["application_date"] = date;
					json["open_date"] = that.orderMain_form.date;
					json["person1"] = that.orderMain_form.CMer_name;
					json["phone1"] = that.orderMain_form.CMer_phone;
					json["email1"] = that.orderMain_form.CMer_email;
					json["person2"] = that.orderMain_form.CPer_name;
					json["phone2"] = that.orderMain_form.CPer_phone;
					json["email2"] = that.orderMain_form.CPer_phone;
				...
				if (key == 2) {
					...
					for (var i=0; i<that.order_form.length; i++) {
						data_detail += i === that.order_form.length - 1? JSON.stringify(that.order_form[i]):JSON.stringify(that.order_form[i])+"&"
					// 	data_detail.push({
					// 		bus_sys_name: that.order_form[i].businessSystem,
					// 		department1_A: that.order_form[i].ACM_department,
					// 		person1_A: that.order_form[i].ACM_header,
					// 		phone1_A: that.order_form[i].ACM_headerMobile
					// 	})
					}
					// json["application_detail"] = that.order_form.join(",");
					json["application_detail"] = data_detail;
					var parmas = JSON.stringify(json);
					console.log(parmas);
					postTicketList(parmas).then((response)=> {
						console.log(response);
  ...
  created () {
	  let date = this.getDate(this.applyDate+864000000)
	  this.orderMain_form.date = date;
	  this.getOrderInitState();
  }
}
</script>
