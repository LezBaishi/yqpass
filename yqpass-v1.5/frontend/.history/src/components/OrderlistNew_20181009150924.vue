					...
					<el-row>
						<el-col :span="14">
							<el-form-item label="Z端业务设备端口" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.port_name_Z" placeholder="如POS 1/1/0或交换机端口-1" clearable></el-input>
							</el-form-item>	
						</el-col>
						<el-col :span="8" :push="1">
							<el-form-item label="端口类型" label-width="120px">
									<el-select  v-model="order_form_empty.port_type_Z" placeholder="请选择">
										<el-option v-for="item in portType_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
									</el-select>
							</el-form-item>	
						</el-col>
