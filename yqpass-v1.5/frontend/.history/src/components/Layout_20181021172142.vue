  ...
  <el-row class="panel">
    <el-row class="top">
      <el-col :span='24' class="panel-top">
        <el-col style="width:180px; padding-left:20px; height: 100%;align-items: flex-end;">
          <img src="../assets/logo1.png"  alt="log" class="img" />
          <!-- <a style="font-size: 28px;color: #ffffff;">ChinaMobile</a> -->
        </el-col>
        <el-col>
          <h1 style="vertical-align: middle;color:#ffffff;">{{ msg }}</h1>
        </el-col>
