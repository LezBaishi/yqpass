...
export default {
  data () {
    return {
      tableData: [
      {
      	orderNum: '20180702-0001-105141',
      	delPerson: '张三',
      	sendTime: '20180702-09:38:58',
      	delState: '待审批'
      },
      {
      	orderNum: '20180702-0001-105142',
      	delPerson: '张三',
      	sendTime: '20180702-09:38:58',
      	delState: '待审批'
      },
      {
      	orderNum: '20180702-0001-105143',
      	delPerson: '张三',
      	sendTime: '20180702-09:38:58',
      	delState: '待审批'
      }],
       tableColumns: [
       { label: '工单号', prop: 'orderNum'},
       { label: '处理人', prop: 'delPerson'},
       { label: '派单时间', prop: 'sendTime'},
       { label: '处理状态', prop: 'delState'}
    ],
    	seen: false,
    	search_form: [
    	{
  ...
  methods: {
  	...
  	resetForm(formName) {
		...
		getOrderList() {
			let reqUrl = "http://127.0.0.1:8080/api/tickets/"
  		let paramsData = new Array();
  		paramsData["category"] = "owner";
			axios.get(reqUrl, {params : paramsData}).then((response)=> {
