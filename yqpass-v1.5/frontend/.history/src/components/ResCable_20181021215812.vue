  	...
  	<el-row class="container">
        ...
        <el-row>
        	<el-col>
		        ...
		        <el-button style='float: right; padding-right:10px; ' type="primary" size="mini" round @click="setPage">设置</el-button>
				<el-button style='float: right;' type="primary" size="mini" round @click="delAll">删除</el-button>
	        	<el-button style='float: right;' type="primary" size="mini" round @click="exportInfo">导出</el-button>
			</el-col>
		</el-row>
		<el-row>
