  	...
  	<el-row  class="container">
       		...
       		<el-row>
      			...
      			<el-col :offset="3" :span="8">
					<el-form-item label="A端信息">
						<el-col :span="11">
							<el-form-item prop="ocable_odf_A">
								<el-input placeholder="A端光缆ODF" v-model="search_form.ocable_odf_A" style="width:100%;" clearable></el-input>
							</el-form-item>
						</el-col>
						<el-col class="line" :span="2">-</el-col>
						<el-col :span="11">
							<el-form-item prop="switch_dport_A">
								<el-input placeholder="A端转接设备端口" v-model="search_form.switch_dport_A" style="width:100%;" clearable></el-input>
							</el-form-item>
						</el-col>
					</el-form-item>
      			</el-col>
      			<el-col :push="2" :span="8">
      				<el-form-item label="Z端信息">
      					<el-col :span="11">
      						<el-form-item prop="ocable_odf_Z">
	      						<el-input placeholder="Z端光缆ODF" v-model="search_form.ocable_odf_Z" style="width:100%;" clearable></el-input>
	      					</el-form-item>
      					</el-col>
      					<el-col class="line" :span="2">-</el-col>
      					<el-col :span="11">
      						<el-form-item prop="switch_dport_Z">
	      						<el-input placeholder="Z端转接设备端口" v-model="search_form.switch_dport_Z" style="width:100%;" clearable></el-input>
	      					</el-form-item>
      					</el-col>
      				</el-form-item>
      			</el-col>	      		
        ...
        <el-row>
        	<el-col>
				...
				<el-button style='float: right;' type="primary" style='float: right;' size="mini" round @click="setPage">设置</el-button>
				<el-button style='float: right;' type="primary" style='float: right;' size="mini" round @click="dialogFormVisible = true">新增</el-button>
			</el-col>
		</el-row>
		<el-row>
...
<script>
import { getCableDetailList } from '../api/api'
export default {
  data () {
    return {
	  tableData: [],
  ...
  methods: {
  	...
  	searchOrder () {
		...
		paramsData["ocable_odf_A"] = this.search_form.ocable_odf_A;
		paramsData["switch_dport_A"] = this.search_form.switch_dport_A;
		paramsData["ocable_odf_Z"] = this.search_form.ocable_odf_Z;
		paramsData["switch_dport_Z"] = this.search_form.switch_dport_Z;
