  ...
  <div>
  	<el-row class="container">
        ...
        <el-row>
			...
			<el-dialog title="新增光缆段" :visible.sync="dialogFormVisible" width="66%" center class="dialog">
...
import { getCableList } from '../api/api'
export default {
  data () {
    return {
	  tableData: [],
  ...
  methods: {
	...
	editDialogForm (index, rows) {
		...
		this.data_dialogForm = this.tableData[index];
	},
