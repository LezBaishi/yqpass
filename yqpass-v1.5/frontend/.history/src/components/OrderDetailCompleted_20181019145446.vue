				...
				<el-form :model="order_form_empty" class="dialogForm">
					...
					<el-row>
						<el-form-item label="A端设备所在楼栋机房" :label-width="formLabelWidth">
							<el-col :span="5">
								<el-select v-model="order_form_empty.building_A" placeholder="请选择机楼" v-on:change="get_machineBuilding($event)">
									<el-option v-for="item in machineBuilding_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
								</el-select>
							</el-col>
							<el-col :span="5" :push="1">
								<el-select v-model="order_form_empty.room_A" placeholder="请选择机房" v-on:change="get_machineRoom($event)">
					...
					<el-row>
						<el-form-item label="Z端设备所在楼栋机房" :label-width="formLabelWidth">
							<el-col :span="5">
								<el-select v-model="order_form_empty.building_Z" placeholder="请选择机楼" v-on:change="get_machineBuilding($event)">
									<el-option v-for="item in machineBuilding_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
								</el-select>
							</el-col>
							<el-col :span="5" :push="1">
								<el-select v-model="order_form_empty.room_Z" placeholder="请选择机房" v-on:change="get_machineRoom($event)">
									<el-option v-for="item in machineRoom_option" :key="item.value" :label="item.label" :value="item.value"></el-option>
								</el-select>
							</el-col>
						</el-form-item>
	...
	getOrderDetail (id) {
		...
		getTicketDetail(id).then((response)=> {
			...
			if (response.data.code == 1) {
				...
				console.log(list.application_detail)
				if (list.application_detail != '') {
