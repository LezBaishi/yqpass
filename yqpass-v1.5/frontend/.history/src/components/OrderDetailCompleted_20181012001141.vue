    ...
    <el-row>
				...
				<el-form :model="order_form_empty" class="dialogForm">
					...
					<el-row>
						<el-form-item label="Z端设备维护合作单位" :label-width="formLabelWidth">
							...
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.phone2_Z"></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
					...
					<el-row>
						<el-col :span="11">
							<el-form-item label="Z端业务设备位置" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.rack_num_Z" placeholder="填写具体机架号：如A02架"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12" :push="1">
							<el-form-item label="Z端业务设备网元名称" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.device_name_Z" placeholder="如S9303交换机或核心交换机"></el-input>
							</el-form-item>	
						</el-col>
					</el-row>
					<el-row>
						<el-col :span="12">
							<el-form-item label="Z端业务设备端口" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.port_name_Z" placeholder="如POS 1/1/0或交换机端口-1"></el-input>
							</el-form-item>	
						</el-col>
						<el-col :span="8" :push="1">
  	...
  	<el-row>
  		<el-table :data="order_form" ref="table" tooltip-effect="dark" border stripe style="width:100%">
  			...
  			<el-table-column label="Z端业务设备位置（填写具体机架号）" prop="rack_num_Z" width="150" align="center">
  				<template slot-scope="scope">
  			...
  			<el-table-column label="Z端业务设备/网元名称" prop="device_name_Z" width="240" align="center">
  				<template slot-scope="scope">
  			...
  			<el-table-column label="Z端业务设备端口" prop="port_name_Z" width="240" align="center">
  				<template slot-scope="scope">
