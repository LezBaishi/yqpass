  	...
  	<el-row class="container">
       		...
       		<el-row>
      			...
      			<el-col :offset="3" :span="8">
      				<el-form-item label="工单编号" prop="orderNum">
      					<el-input v-model="search_form.orderNum" placeholder="请输入工单号" clearable></el-input>
      				</el-form-item>
      			</el-col>
	      	...
	      	<el-row>
	      		<el-col :offset="3" :span="8">
	      			<el-form-item label="工单标题" prop="title">
	      				<el-input v-model="search_form.title" placeholder="请输入工单标题" clearable></el-input>
	      			</el-form-item>
	      		</el-col>
	      		<el-col :push="2" :span="8">
        ...
        <el-row>
          <el-col :span='12' class="button_nav">
          	<el-button type="info" icon="el-icon-search" size="mini" circle style='float: left;' @click="searchBtn"></el-button>
           	<el-button type="info" icon="el-icon-refresh" size="mini" circle style='float: left;' @click="refreshBtn"></el-button>        	  
          </el-col>
