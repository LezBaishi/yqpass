  ...
  <el-row class="footer">
	...
	<el-row class="transfer_record" v-if="ins_seen">
		<el-collapse v-model="activeNames" @change="handleChange">
			<el-collapse-item v-for="(value, key, index) in flowLogs" name=index>
				<template slot="title">
					<div>工单状态：{{ value.state,index }}</div>
				</template>
				<div>工单状态：{{value.state}}，处理人：{{value.participant}}，处理结果：{{value.transition}}，处理意见：{{value.suggestion}}， 处理时间：{{value.gmt_modified}}</div>
			</el-collapse-item>
		</el-collapse>
	</el-row>  
