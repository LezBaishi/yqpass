				...
				<el-form :model="order_form_empty" class="dialogForm">
					...
					<el-row>
						<el-form-item label="Z端设备移动维护部门" :label-width="formLabelWidth">
							...
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.phone1_Z"></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
						<el-form-item label="Z端设备维护合作单位" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="单位名称：如XX公司" v-model="order_form_empty.department2_Z"></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="公司负责人" v-model="order_form_empty.person2_Z"></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.person2_ZMobile"></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
