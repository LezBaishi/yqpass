  	...
  	<el-row class="container">
        ...
        <el-row>
        	<el-col :push="20" :span="1">
				<el-button type="primary" size="mini" round @click="dialogFormVisible = true">新增</el-button>
        	</el-col>
        	<el-col :push="20" :span="1">
		        <el-button type="primary" size="mini" round @click="setPage">设置</el-button>
			</el-col>
			<el-col :push="20" :span="1">
				<el-button type="primary" size="mini" round @click="delAll">删除</el-button>
			</el-col>
    		<el-col :push="20" :span="1">
	        	<el-button type="primary" size="mini" round @click="exportInfo">导出</el-button>
			</el-col>
