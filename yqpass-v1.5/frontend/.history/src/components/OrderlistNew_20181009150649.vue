				...
				<el-form :model="order_form_empty" class="dialogForm">
					...
					<el-row>
						<el-form-item label="A端业务设备位置" :label-width="formLabelWidth">
							<el-input v-model="order_form_empty.rack_num_A" placeholder="填写具体机架号：如A02架" clearable></el-input>
						</el-form-item>
					</el-row>
					<el-row>
						<el-form-item label="A端业务设备网元名称" :label-width="formLabelWidth">
							<el-input v-model="order_form_empty.device_name_A" placeholder="如S9303交换机或核心交换机" clearable></el-input>
						</el-form-item>	
					</el-row>
					<el-row>
						<el-col :span="14">
							<el-form-item label="A端业务设备端口" :label-width="formLabelWidth">
								<el-input v-model="order_form_empty.port_name_A" placeholder="如POS 1/1/0或交换机端口-1" clearable></el-input>
							</el-form-item>	
						</el-col>
