			...
			<el-dialog title="新增项目" :visible.sync="dialogFormVisible">
				<el-form :model="order_form_empty">
					...
					<el-form-item label="A端设备移动维护部门" :label-width="formLabelWidth">
						<el-input placeholder="部门名称" v-model="order_form_empty.ACM_department" width="140"></el-input>
						<el-input placeholder="移动负责人" v-model="order_form_empty.ACM_header"></el-input>
