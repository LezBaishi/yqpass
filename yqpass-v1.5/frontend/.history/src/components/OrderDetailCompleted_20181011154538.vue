					...
					<el-row>
						<el-form-item label="A端设备移动维护部门" :label-width="formLabelWidth">
							...
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.phone1_A"></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
						<el-form-item label="A端设备维护合作单位" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="单位名称：如XX公司" v-model="order_form_empty.department2_A"></el-input>
							</el-col>
							<el-col :span="7" :push="1">
								<el-input placeholder="公司负责人" v-model="order_form_empty.person2_A"></el-input>
							</el-col>
							<el-col :span="7" :push="2">
								<el-input placeholder="联系方式" v-model="order_form_empty.person2_AMobile"></el-input>
							</el-col>
						</el-form-item>
					</el-row>
					<el-row>
  	...
  	<el-row>
  		<el-table :data="order_form" ref="table" tooltip-effect="dark" border stripe style="width:100%">
  			...
  			<el-table-column label="A端设备维护合作单位" align="center">
  				...
  				<el-table-column label="联系方式" prop="person2_AMobile" width="140" align="center">
  					<template slot-scope="scope">
	  					<el-input v-show="scope.row.edit" v-model="scope.row.person2_AMobile"></el-input>
	  					<span v-show="!scope.row.edit">{{ scope.row.person2_AMobile }}</span>
  					</template>
  				</el-table-column>
  			</el-table-column>
  ...
  methods: {
	...
	submitDialogForm(formName) {
		...
		this.order_form.push({
			...
			person2_AMobile:this.order_form_empty.person2_AMobile,
