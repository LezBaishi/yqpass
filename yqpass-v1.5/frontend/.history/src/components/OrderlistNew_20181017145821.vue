  ...
  methods: {
	...
	submitDialogForm(formName) {
		...
		if (this.data_dialogForm == this.order_form_empty) {
			...
			// var A_machineRoom_text = ''
			// setTimeout("A_machineRoom_text = this.get_roomByid(this.order_form_empty.A_machineRoom)", 1000);
			// console.log(A_machineRoom_text);
			this.get_roomByid(this.order_form_empty.A_machineBuilding, this.order_form_empty.A_machineRoom);
			this.order_form.push({
				...
				A_machineRoom:A_machineRoom_text,
