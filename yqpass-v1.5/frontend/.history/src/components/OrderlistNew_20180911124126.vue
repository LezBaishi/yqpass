		...
		<el-button type="primary" style="float:right;margin-bottom:10px;" size="mini" round @click="dialogFormVisible = true">新增表行</el-button>  
			<el-dialog title="新增项目" :visible.sync="dialogFormVisible" class="dialogForm">
				<el-form :model="order_form_empty">
					...
					<el-row>
						<el-form-item label="A端业务设备所在楼栋机房" :label-width="formLabelWidth">
							<el-col :span="8">
							...
							<el-col :span="8">
								<el-select v-model="order_form_empty.row.A_machineRoom" placeholder="请选择机房" v-on:change="get_machineRoom($event)">
