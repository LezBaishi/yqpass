				...
				<el-form :model="order_form_empty" class="dialogForm">
					...
					<el-row>
						<el-form-item label="A端设备移动维护部门" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="部门名称：如XX中心" v-model="order_form_empty.ACM_department" clearable></el-input>
							</el-col>
					...
					<el-row>
						<el-form-item label="A端设备维护合作单位" :label-width="formLabelWidth">
							<el-col :span="8">
								<el-input placeholder="单位名称：如XX公司" v-model="order_form_empty.ACP_department" clearable></el-input>
							</el-col>
							<el-col :span="7" :push="1">
