...
//新建纤芯
export const newCableDetail = (params) => {
	return axios.post(`${host}/resmanage/ofiber_core/`, params)
}

//编辑光缆段
export const editCableDetail = (id,params) => {
	return axios.post(`${host}/resmanage/`+id+`/ofiber_core/`, params)
}

//删除光缆段
export const delCableDetail = (params) => {
	return axios.post(`${host}/resmanage/ofiber_core/delete/`, params)
}