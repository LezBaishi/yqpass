					...
					<el-row>
						<el-col :span="8">
							<el-form-item label="A端业务设备楼栋" :label-width="formLabelWidth">							
								<el-select v-model="data_dialogForm.building_A" placeholder="请选择" v-on:change="get_machineBuilding($event)">
						...
						<el-col :span="8" :push="2">
							<el-form-item label="机房号" label-width="120px">
								<el-select v-model="data_dialogForm.room_A" placeholder="请选择" v-on:change="get_machineRoom($event)">
