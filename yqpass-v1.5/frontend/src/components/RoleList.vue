        	...
        	<el-table :data="tableData" v-loading="loading">
  			...
  			<el-table-column
            	...
            	<template slot-scope="scope">
					<el-button type="primary" size="mini" circle icon="el-icon-view" @click="onBtnDetailClick(scope.$index, tableData)"></el-button>
					<el-button type="danger" size="mini" circle icon="el-icon-delete" @click="onBtnDeleteClick(scope.$index, tableData)"></el-button>
            	</template>
       		 </el-table-column>
  			</el-table>
		</el-row>
  ...
  methods: {
	...
	refreshBtn () {
  	...
  	searchOrder () {
		this.$data.seen = false;
		let paramsData = {};
		paramsData["role_name"] = this.search_form.roleName;
	...
	onBtnDetailClick (index, rows) {
		...
		this.$router.push({path: '/3/roleListDetail', query: {id: rowValue.id}})
	},
